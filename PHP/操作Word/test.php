...
// 更好的实现方式是引用PHPWord类库，或者其它更方便操作Word的类库来创建Word
...
<hr size=1>
<p>
    如果你打开data.doc，看到了这里的介绍，则说明word文档创建成功了。
</p>
<p>
...
<p>
    等你输出完毕后，用$word->save($path)方法，其中$path是你想
...
<p>
    这是本人想到的一个很有意思的方法，它的实现方法出人意料的简单，并且避免
    了对windows环境的依赖。
</p>
<br>
哈哈，很有意思吧？享受它吧！
