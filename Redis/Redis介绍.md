...
![2](D:\xampp\htdocs\mytest\Git\self-study\Redis\image\2.jpeg)
...
![1](D:\xampp\htdocs\mytest\Git\self-study\Redis\image\1.png)
...
![3](D:\xampp\htdocs\mytest\Git\self-study\Redis\image\3.png)
...
![4](D:\xampp\htdocs\mytest\Git\self-study\Redis\image\4.jpeg)
...
![5](D:\xampp\htdocs\mytest\Git\self-study\Redis\image\5.jpeg)
...
![6](D:\xampp\htdocs\mytest\Git\self-study\Redis\image\6.jpeg)
...
![7](D:\xampp\htdocs\mytest\Git\self-study\Redis\image\7.jpeg)



①每个 Sentinel 节点都需要定期执行以下任务：每个 Sentinel 以每秒一次的频率，向它所知的主服务器、从服务器以及其他的 Sentinel 实例发送一个 PING 命令。（如上图）

![8](D:\xampp\htdocs\mytest\Git\self-study\Redis\image\8.jpeg)

②如果一个实例距离最后一次有效回复 PING 命令的时间超过 down-after-milliseconds 所指定的值，那么这个实例会被 Sentinel 标记为主观下线。（如上图）

![9](D:\xampp\htdocs\mytest\Git\self-study\Redis\image\9.jpeg)



③如果一个主服务器被标记为主观下线，那么正在监视这个服务器的所有 Sentinel 节点，要以每秒一次的频率确认主服务器的确进入了主观下线状态。

![10](D:\xampp\htdocs\mytest\Git\self-study\Redis\image\10.jpeg)



④如果一个主服务器被标记为主观下线，并且有足够数量的 Sentinel（至少要达到配置文件指定的数量）在指定的时间范围内同意这一判断，那么这个主服务器被标记为客观下线。

![11](D:\xampp\htdocs\mytest\Git\self-study\Redis\image\11.jpeg)
...
![12](D:\xampp\htdocs\mytest\Git\self-study\Redis\image\12.jpeg)



⑥Sentinel 和其他 Sentinel 协商客观下线的主节点的状态，如果处于 SDOWN 状态，则投票自动选出新的主节点，将剩余从节点指向新的主节点进行数据复制。

![13](D:\xampp\htdocs\mytest\Git\self-study\Redis\image\13.jpeg)
